class Parser:
    ...
    def _parseLine(self, line, n):
        ...
        if l[0] == "push":
            if len(l) == 3 and l[2].isnumeric(): #provjeri je li broj tj. f-ja .isnumeric
            ...
            if len(l) == 3 and l[2].isnumeric(): #isto kao i za push
                return "//" + " ".join(l) + "\n" + self._pop(l[1], l[2], n)
            else:
                self._flag = False
                Parser._error("Parser", n, "Undefined command")
            ...
            if l[0] == "label" and len(l) == 2:
                ...
                if self._func + "$" + l[1] in self._labels:  #referenciranje nedefiniranih oznaka
                    return "//" + " ".join(l) + "\n" + self._goto(l[1], n)
                else:
                    self._flag = False
                ...
                if self._func + "$" + l[1] in self._labels:  #isto kao i za goto
                    return "//" + " ".join(l) + "\n" + self._ifgoto(l[1], n)
                else:
                    self._flag = False
                    Parser._error("Parser", n, " undefined label")
